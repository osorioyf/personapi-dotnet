...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A6CD6D6282");

            entity.ToTable("estudios");

            entity.HasIndex(e => e.Fecha, "idx_estudios_fecha");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666DF36FBBEB");

            entity.ToTable("persona");

            entity.HasIndex(e => e.Apellido, "idx_persona_apellido");

            entity.HasIndex(e => e.Nombre, "idx_persona_nombre");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83FCC86E80B");

            entity.ToTable("profesion");

            entity.HasIndex(e => e.Nom, "idx_profesion_nom");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D65F8264A63");

            entity.ToTable("telefono");

            entity.HasIndex(e => e.Duenio, "idx_telefono_dueño");
